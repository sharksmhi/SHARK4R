...
```{r datasetname}
datasetname = paste("Processing dataset:", myfile$dataset_file_name, sep=" ")
```

## Set conditions
```{r runoncondition, echo = FALSE, include = FALSE}
# execute code depending on datatype
do_it_bact = sub("^[^_]*_([^_]*).*", "\\1", myfile$dataset_file_name) == 'Bacterioplankton'
do_it_chl = sub("^[^_]*_([^_]*).*", "\\1", myfile$dataset_file_name) == 'Chlorophyll'
do_it_epi = sub("^[^_]*_([^_]*).*", "\\1", myfile$dataset_file_name) == 'Epibenthos'
do_it_grey = sub("^[^_]*_([^_]*).*", "\\1", myfile$dataset_file_name) == 'GreySeal'
do_it_harbp = sub("^[^_]*_([^_]*).*", "\\1", myfile$dataset_file_name) == 'HarbourPorpoise'
do_it_harbs = sub("^[^_]*_([^_]*).*", "\\1", myfile$dataset_file_name) == 'HarbourSeal'
do_it_phychem = sub("^[^_]*_([^_]*).*", "\\1", myfile$dataset_file_name) == 'PhysicalChemical'
do_it_phyto = sub("^[^_]*_([^_]*).*", "\\1", myfile$dataset_file_name) == 'Phytoplankton'
do_it_pico = sub("^[^_]*_([^_]*).*", "\\1", myfile$dataset_file_name) == 'Picoplankton'
do_it_pp = sub("^[^_]*_([^_]*).*", "\\1", myfile$dataset_file_name) == 'PrimaryProduction'
do_it_ring = sub("^[^_]*_([^_]*).*", "\\1", myfile$dataset_file_name) == 'RingedSeal'
do_it_sealpath = sub("^[^_]*_([^_]*).*", "\\1", myfile$dataset_file_name) == 'SealPathology'
do_it_sed = sub("^[^_]*_([^_]*).*", "\\1", myfile$dataset_file_name) == 'Sedimentation'
do_it_zoob = sub("^[^_]*_([^_]*).*", "\\1", myfile$dataset_file_name) == 'Zoobenthos'
do_it_zoop = sub("^[^_]*_([^_]*).*", "\\1", myfile$dataset_file_name) == 'Zooplankton'
```
