...
# Retrieve all epibenthos data from July 2015
shark_data <- get_shark_data(tableView = "sharkdata_epibenthos",
                             fromYear = 2015, 
                             toYear = 2015,
                             months = 7,
                             dataTypes = c("Epibenthos"),
                             verbose = FALSE)
...
```{r}
# Update taxonomy information for the retrieved epibenthos data using Dyntaxa
