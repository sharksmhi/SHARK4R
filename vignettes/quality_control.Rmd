...
SHARK data can be downloaded and saved locally using the `save_dir` argument, then imported into R using the function `shark_read()` for both ZIP archives or text files.
