...
Phytoplankton data, including scientific names and AphiaIDs, are downloaded from SHARK. To see more download options, please visit the [Retrieve Data From SHARK](https://sharksmhi.github.io/SHARK4R/articles/01_retrieve_shark_data.html) tutorial.

```{r}
# Retrieve all phytoplankton data from April 2020
...
SHARK sources taxonomic information from [Dyntaxa](https://sharksmhi.github.io/SHARK4R/articles/02_retrieve_dyntaxa_data.html), which is reflected in columns starting with `taxon_xxxxx`. Equivalent columns based on WoRMS can be retrieved using the [`update_worms_taxonomy`](../reference/update_worms_taxonomy.html) function.
...
plankton_groups <- assign_phytoplankton_group(scientific_name,
                                              aphia_id,
                                              verbose = FALSE)
