...
#> after 10000 ms: Timeout was reached - Retrying...
...
#> www.marinespecies.org port 443 after 10001 ms: Timeout was reached
...
#> Warning: Attempt 1 failed for AphiaID 109604: Timeout was reached
#> [www.marinespecies.org]: SSL connection timeout - Retrying...
#> Warning: Attempt 2 failed for AphiaID 109604: Couldn't connect to server
#> [www.marinespecies.org]: Failed to connect to www.marinespecies.org port 443
#> after 1144 ms: Couldn't connect to server - Retrying...
#> Error in value[[3L]](cond) : 
#>   Error retrieving WoRMS record for AphiaID 109604 after 3 attempts:
#> Couldn't connect to server [www.marinespecies.org]: Failed to connect to
#> www.marinespecies.org port 443 after 124 ms: Couldn't connect to server
...
#> Warning: Attempt 1 failed for AphiaID 109604: Couldn't connect to server
#> [www.marinespecies.org]: Failed to connect to www.marinespecies.org port 443
#> after 122 ms: Couldn't connect to server - Retrying...
#> Warning: Attempt 2 failed for AphiaID 109604: Couldn't connect to server
#> [www.marinespecies.org]: Failed to connect to www.marinespecies.org port 443
#> after 133 ms: Couldn't connect to server - Retrying...
#> # A tibble: 2 × 31
#>   AphiaID url   scientificname authority status unacceptreason taxonRankID rank 
#>     <int> <chr> <chr>          <chr>     <chr>  <lgl>                <int> <chr>
#> 1  109604 http… Dinophysis ac… Ehrenber… accep… NA                     220 Spec…
#> 2  376667 http… Skeletonema m… Sarno & … unass… NA                     220 Spec…
#> # ℹ 23 more variables: valid_AphiaID <int>, valid_name <chr>,
