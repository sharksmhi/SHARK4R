...
parent taxon IDs for the specified taxon IDs. It constructs a request
with the provided taxon IDs, sends the request to the SLU Artdatabanken
API, and processes the response to return a list of parent taxon IDs.
...
- taxon_ids:
  ...
  A vector of numeric taxon IDs for which parent taxon IDs are
  requested.
...
A list containing parent taxon IDs corresponding to the specified taxon
IDs.
