...
Database](https://toxins.hais.ioc-unesco.org/api/toxins/) and returns
...
a list of toxins with detailed information.

## See also

<https://toxins.hais.ioc-unesco.org/api/toxins/> for IOC-UNESCO Toxins
Database.
